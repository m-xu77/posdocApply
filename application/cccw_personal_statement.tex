...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\small\itshape Xu --- Personal Statement --- \thepage\ of \pageref{LastPage}}
...
\begin{center}
  ...
  {\normalsize Postdoctoral Fellowship, Centre on Contemporary China and the World (Ref.\ 535079)}\\[2pt]
  {\normalsize University of Hong Kong}\\[4pt]
  {\large Mengnan Xu}
\end{center}
...
My doctoral dissertation, \textit{The Impact of Targeted Poverty Alleviation Policies on
...
Poverty in China'' (\textit{Journal of Contemporary China}, 2022, SSCI Q1), provides the
...
control policy evaluation using longitudinal administrative data (\textit{BMJ Open}, 2019;
\textit{Health}, 2019).

The household-level causal analysis and the organizational ecology work share a
methodological gap. The dissertation establishes \textit{what} the policy achieves at the
household level. The organizational ecology work maps \textit{who} implements it and
...
his work on elite politics and the \textit{Chinese Politics in the Xi Jinping Era} examines
